...
class UASGController:
    ...
    def fetch_and_create_table(self):
        """Busca os dados de UASG e cria a tabela."""
        ...
        if uasg in self.loaded_uasgs:
            self.view.label.setText(f"UASG {uasg} já carregada.")
            return
        ...
        try:
            ...
            self.view.label.setText(f"Dados da UASG {uasg} carregados com sucesso!")
